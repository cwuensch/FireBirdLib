...
static void OSDMenuKeyboard_SetShiftState(void)
{
...
static void OSDMenuKeyboard_CursorLeft(void)
{
...
static void OSDMenuKeyboard_CursorRight(void)
{
...
static void OSDMenuKeyboard_CursorEnd(void)
{
...
static void OSDMenuKeyboard_DeleteLeft(void)
{
  if(OSDMenuKeyboard_CursorPosition > 0)
  {
    OSDMenuKeyboard_CursorPosition--;
...
static void OSDMenuKeyboard_DeleteRight(void)
{
  if(OSDMenuKeyboard_CursorPosition < (int)strlen(OSDMenuKeyboard_StringVar))
  {
    DeleteAt(OSDMenuKeyboard_StringVar, OSDMenuKeyboard_CursorPosition, 1);
...
static void OSDMenuKeyboard_ClearAll(void)
{
...
static void OSDMenuKeyboard_RestoreOrig(void)
{
  memset(OSDMenuKeyboard_StringVar, 0, OSDMenuKeyboard_StringMaxLen + 4);
...
static void OSDMenuKeyboard_SaveAndFinish(void)
{
    ...
    case EVT_KEY:
    {
      switch(*param1)
      {
        ...
        case RKEY_Ok:         //Zeichen übernehmen
        {
          ...
          switch(KeyPadPosition)
          {
            case 26:  // Space
            {
              ...
              {
                InsertCharsAt(OSDMenuKeyboard_StringVar, OSDMenuKeyboard_CursorPosition, " ", 1);
                OSDMenuKeyboard_CursorPosition++;
                OSDMenuKeyboard_DrawText();
                OSDMenuKeyboard_SetShiftState();
              }
            ...
            default:
            {
              if(strlen(OSDMenuKeyboard_StringVar) < OSDMenuKeyboard_StringMaxLen)
              {
                InsertCharsAt(OSDMenuKeyboard_StringVar, OSDMenuKeyboard_CursorPosition, &Keypad[KeyPadMode][KeyPadPosition], 1);
                OSDMenuKeyboard_CursorPosition++;
                OSDMenuKeyboard_DrawText();
        ...
        case RKEY_9:
        {
          if(strlen(OSDMenuKeyboard_StringVar) < OSDMenuKeyboard_StringMaxLen)
          {
            char ToBeInserted = '0' + (*param1 & 0x0f);
            InsertCharsAt(OSDMenuKeyboard_StringVar, OSDMenuKeyboard_CursorPosition, &ToBeInserted, 1);
            OSDMenuKeyboard_CursorPosition++;
            OSDMenuKeyboard_DrawText();
            OSDMenuKeyboard_SetShiftState();
          }
...
/*          KeyPadShiftState = !KeyPadShiftState;
        ...
        {
          OSDMenuKeyboard_RestoreOrig();
          break;
        }

        case RKEY_Blue:       //Gesamten Text löschen
        {
          OSDMenuKeyboard_ClearAll();
          break;
        }
...
//          snprintf(OSDMenuKeyboard_Clipboard, sizeof(OSDMenuKeyboard_Clipboard), "%s", OSDMenuKeyboard_StringVar);
          strncpy(OSDMenuKeyboard_Clipboard, OSDMenuKeyboard_StringVar, sizeof(OSDMenuKeyboard_Clipboard) - 1);
        ...
        case RKEY_Yellow:     //Aus Zwischenablage einfügen
        {
          ...
          {
            strncpy(OSDMenuKeyboard_StringVar, OSDMenuKeyboard_Clipboard, OSDMenuKeyboard_StringMaxLen);
            OSDMenuKeyboard_Clipboard[OSDMenuKeyboard_StringMaxLen] = '\0';
            OSDMenuKeyboard_TextStartPosition = 0;
            OSDMenuKeyboard_CursorEnd();
          }
          break;
        ...
        case RKEY_Exit:       //Beenden ohne Speichern
        {
          ...
          else if (OSDMenuKeyboard_isEmpty()) break;
          OSDMenuKeyboard_SaveAndFinish();
          return TRUE;
          break;
        }
      ...
      switch(*param1)
      {
        ...
        default:
        {
          ...
          if((*param1 < 0x100) && (((*param1 >= 0x20) && (*param1 < 0x7f)) || (*param1 >= 0xa0)))
          {
            if(strlen(OSDMenuKeyboard_StringVar) < OSDMenuKeyboard_StringMaxLen)
            {
              InsertCharsAt(OSDMenuKeyboard_StringVar, OSDMenuKeyboard_CursorPosition, (char*)param1, 1);
              OSDMenuKeyboard_CursorPosition++;
              OSDMenuKeyboard_DrawText();
              OSDMenuKeyboard_SetShiftState();
            }
