...
int TAP_Main()
{
  ...
  infData_DeleteAbs(NULL, NULL);
  infData_FlenAbs();
  infData_Get(NULL, NULL, NULL, NULL);
  infData_GetAbs(NULL, NULL, NULL, NULL);
  infData_GetNameByIndex(NULL, 0, NULL);
  infData_GetNameByIndexAbs(NULL, 0, NULL);
  infData_isAvail(NULL, NULL, NULL);
  infData_isAvailAbs(NULL, NULL, NULL);
  infData_LocateSigAbs(NULL, NULL);
  infData_LocToAbs(NULL);
  infData_OpenFileAbs(NULL);
  infData_Set(NULL, NULL, 0, NULL);
  infData_SetAbs(NULL, NULL, 0, NULL);
  infData_TruncateAbs(NULL, 0);
  INICloseFile();
