...
int HDD_Smart_ReadThresholdData (word *DataBuf)
{
  ...
  unsigned char         CommandBlock[HDIO_DRIVE_CMD_HDR_SIZE + 512] = {WIN_SMART, 0, SMART_READ_THRESHOLDS, 1,};
  ...
  RS = intLock ();
  Ret = SendHDDCommand (SMART_READ_THRESHOLDS, 0, 0, 0x4F, 0xC2, 0xA0, WIN_SMART);
  if (Ret != 0)
  {
